			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
						...
						@empty
							<tr>
								<td colspan="12" class="text-center">عفوا لا يوجد اى فواتير</td>
							</tr>
						@endforelse
						</tbody>
					</table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('invoices.archives.destroy') }}" method="post">
                        {{ csrf_field() }}
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ URL::route('restore.invoice') }}" method="post">
                        {{ csrf_field() }}
                </div>
                <div class="modal-body">
